  ...
  <table width="100%" border="0" cellpadding="20">
   <tr>
    <td>
      ...
      <p><asp:Button ID="btn_GetInterface" runat="server" Text="&nbsp;&nbsp; &nbsp;" />
      Get an object that implements IMyInterface.</p>
      
      <p><asp:Button ID="btn_RegisterNew" runat="server" Text="&nbsp;&nbsp; &nbsp;" />
      Register a different object that implements IMyInterface.</p>

      <p><asp:Button ID="btn_GetLogger" runat="server" Text="&nbsp;&nbsp; &nbsp;" />
      ...
      <p><asp:Button ID="btn_ConstructorInjection" runat="server" Text="&nbsp;&nbsp; &nbsp;" />
      Get an object that uses Constructor Injection.</p>

      <p><asp:Button ID="btn_ReloadContainer" runat="server" Text="&nbsp;&nbsp; &nbsp;" />
